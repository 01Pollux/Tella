...
namespace gcsdk
{
	...
	{
		static IMemberFuncThunk<bool, const ProtoMsgBase&> proto_send("client.dll", "GCClientSystem::SendMsg [proto base]");
		return proto_send;
	...
	{
		static IMemberFuncThunk<bool, const GCMsgBase&> msg_send("client.dll", "GCClientSystem::SendMsg[msg base]");
		return msg_send;
	}

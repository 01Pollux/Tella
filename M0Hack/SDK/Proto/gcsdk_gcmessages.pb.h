...
template<> ::CMsgGCToGCIncrementRecruitmentLevel* Arena::CreateMaybeMessage<::CMsgGCToGCIncrementRecruitmentLevel>(Arena*);
...
class CMsgGCToGCIncrementRecruitmentLevel final :
